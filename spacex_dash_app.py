...
def scatterChart(site, payloadRange):
    if site == 'ALL':
        ...
        fig = px.scatter(
            ...
            title = f'All sites - payload mass between {int(payloadRange[0])}kg and {payloadRange[1]}kg'
        )
    else:
        ...
        fig = px.scatter(
            ...
            y = 'class', 
            color = 'Booster Version Category', 
            title = f'{site} - payload mass between {int(payloadRange[0])}kg and {payloadRange[1]}kg'
        )
